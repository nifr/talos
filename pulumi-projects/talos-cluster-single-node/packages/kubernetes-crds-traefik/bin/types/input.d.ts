...
export declare namespace hub {
    namespace v1alpha1 {
        ...
        interface APIBundleSpec {
             ...
             */
            apis?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.APIBundleSpecApis>[]>;
            /**
        ...
        interface APIBundleSpecApiSelector {
             ...
             */
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.APIBundleSpecApiSelectorMatchExpressions>[]>;
            /**
        ...
        interface APIBundleSpecApiSelectorPatch {
             ...
             * matchExpressions is a list of label selector requirements. The requirements are ANDed.
             */
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.APIBundleSpecApiSelectorMatchExpressionsPatch>[]>;
            /**
             * matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
             * map is equivalent to an element of matchExpressions, whose key field is "key", the
             * operator is "In", and the values array contains only "value". The requirements are ANDed.
        ...
        interface APIBundleSpecPatch {
             ...
             * When combined with APISelector, this set of APIs is appended to the matching APIs.
             */
            apis?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.APIBundleSpecApisPatch>[]>;
            /**
             * Title is the human-readable name of the APIBundle that will be used on the portal.
             */
            title?: pulumi.Input<string>;
        ...
        interface APICatalogItemSpec {
             ...
             */
            apiBundles?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.APICatalogItemSpecApiBundles>[]>;
             ...
             * When combined with APISelector, this set of APIs is appended to the matching APIs.
             */
            apis?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.APICatalogItemSpecApis>[]>;
            /**
        ...
        interface APICatalogItemSpecApiSelector {
             ...
             * matchExpressions is a list of label selector requirements. The requirements are ANDed.
             */
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.APICatalogItemSpecApiSelectorMatchExpressions>[]>;
            /**
             * matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
             * map is equivalent to an element of matchExpressions, whose key field is "key", the
             * operator is "In", and the values array contains only "value". The requirements are ANDed.
        ...
        interface APICatalogItemSpecApiSelectorPatch {
             ...
             * matchExpressions is a list of label selector requirements. The requirements are ANDed.
             */
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.APICatalogItemSpecApiSelectorMatchExpressionsPatch>[]>;
            /**
             * matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
             * map is equivalent to an element of matchExpressions, whose key field is "key", the
             * operator is "In", and the values array contains only "value". The requirements are ANDed.
        ...
        interface APICatalogItemSpecPatch {
             ...
             * Multiple APICatalogItem can select the same APIBundles.
             */
            apiBundles?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.APICatalogItemSpecApiBundlesPatch>[]>;
             ...
             * When combined with APISelector, this set of APIs is appended to the matching APIs.
             */
            apis?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.APICatalogItemSpecApisPatch>[]>;
            /**
             * Everyone indicates that all users will see these APIs.
             */
            everyone?: pulumi.Input<boolean>;
        ...
        interface APIRateLimitSpec {
             ...
             * When combined with APISelector, this set of APIs is appended to the matching APIs.
             */
            apis?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.APIRateLimitSpecApis>[]>;
            /**
        ...
        interface APIRateLimitSpecApiSelector {
             ...
             * matchExpressions is a list of label selector requirements. The requirements are ANDed.
             */
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.APIRateLimitSpecApiSelectorMatchExpressions>[]>;
            /**
             * matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
             * map is equivalent to an element of matchExpressions, whose key field is "key", the
             * operator is "In", and the values array contains only "value". The requirements are ANDed.
        ...
        interface APIRateLimitSpecApiSelectorPatch {
             ...
             * matchExpressions is a list of label selector requirements. The requirements are ANDed.
             */
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.APIRateLimitSpecApiSelectorMatchExpressionsPatch>[]>;
            /**
             * matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
             * map is equivalent to an element of matchExpressions, whose key field is "key", the
             * operator is "In", and the values array contains only "value". The requirements are ANDed.
        ...
        interface APIRateLimitSpecPatch {
             ...
             * When combined with APISelector, this set of APIs is appended to the matching APIs.
             */
            apis?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.APIRateLimitSpecApisPatch>[]>;
            /**
             * Everyone indicates that all users will, by default, be rate limited with this configuration.
             * If an APIRateLimit explicitly target a group, the default rate limit will be ignored.
             */
        ...
        interface APISpec {
             ...
             */
            versions?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.APISpecVersions>[]>;
        }
        /**
        ...
        interface APISpecOpenApiSpec {
             ...
             */
            operationSets?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.APISpecOpenApiSpecOperationSets>[]>;
        ...
        interface APISpecOpenApiSpecOperationSets {
             ...
             */
            matchers?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.APISpecOpenApiSpecOperationSetsMatchers>[]>;
            /**
        ...
        interface APISpecOpenApiSpecOperationSetsPatch {
             ...
             * Matchers defines a list of alternative rules for matching OpenAPI operations.
             */
            matchers?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.APISpecOpenApiSpecOperationSetsMatchersPatch>[]>;
            /**
             * Name is the name of the OperationSet to reference in APICatalogItems or ManagedSubscriptions.
             */
            name?: pulumi.Input<string>;
        ...
        interface APISpecOpenApiSpecOverride {
            servers?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.APISpecOpenApiSpecOverrideServers>[]>;
        }
        /**
         * Override holds data used to override OpenAPI specification.
         */
        interface APISpecOpenApiSpecOverridePatch {
            servers?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.APISpecOpenApiSpecOverrideServersPatch>[]>;
        }
        ...
        interface APISpecOpenApiSpecPatch {
             ...
             * OperationSets defines the sets of operations to be referenced for granular filtering in APICatalogItems or ManagedSubscriptions.
             */
            operationSets?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.APISpecOpenApiSpecOperationSetsPatch>[]>;
        ...
        interface APISpecPatch {
             ...
             * Versions are the different APIVersions available.
             */
            versions?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.APISpecVersionsPatch>[]>;
        }
        /**
        ...
        interface APIVersionSpecOpenApiSpec {
             ...
             * OperationSets defines the sets of operations to be referenced for granular filtering in APICatalogItems or ManagedSubscriptions.
             */
            operationSets?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.APIVersionSpecOpenApiSpecOperationSets>[]>;
        ...
        interface APIVersionSpecOpenApiSpecOperationSets {
             ...
             * Matchers defines a list of alternative rules for matching OpenAPI operations.
             */
            matchers?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.APIVersionSpecOpenApiSpecOperationSetsMatchers>[]>;
            /**
             * Name is the name of the OperationSet to reference in APICatalogItems or ManagedSubscriptions.
             */
            name?: pulumi.Input<string>;
        ...
        interface APIVersionSpecOpenApiSpecOperationSetsPatch {
             ...
             * Matchers defines a list of alternative rules for matching OpenAPI operations.
             */
            matchers?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.APIVersionSpecOpenApiSpecOperationSetsMatchersPatch>[]>;
            /**
             * Name is the name of the OperationSet to reference in APICatalogItems or ManagedSubscriptions.
             */
            name?: pulumi.Input<string>;
        ...
        interface APIVersionSpecOpenApiSpecOverride {
            servers?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.APIVersionSpecOpenApiSpecOverrideServers>[]>;
        }
        /**
         * Override holds data used to override OpenAPI specification.
         */
        interface APIVersionSpecOpenApiSpecOverridePatch {
            servers?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.APIVersionSpecOpenApiSpecOverrideServersPatch>[]>;
        }
        ...
        interface APIVersionSpecOpenApiSpecPatch {
             ...
             * OperationSets defines the sets of operations to be referenced for granular filtering in APICatalogItems or ManagedSubscriptions.
             */
            operationSets?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.APIVersionSpecOpenApiSpecOperationSetsPatch>[]>;
        ...
        interface ManagedApplicationSpec {
             ...
             */
            apiKeys?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.ManagedApplicationSpecApiKeys>[]>;
            /**
        ...
        interface ManagedApplicationSpecPatch {
             ...
             * APIKeys references the API keys used to authenticate the application when calling APIs.
             */
            apiKeys?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.ManagedApplicationSpecApiKeysPatch>[]>;
            /**
             * AppID is the identifier of the ManagedApplication.
             * It should be unique.
             */
        ...
        interface ManagedSubscriptionSpec {
             ...
             */
            apiBundles?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.ManagedSubscriptionSpecApiBundles>[]>;
             ...
             * When combined with APISelector, this set of APIs is appended to the matching APIs.
             */
            apis?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.ManagedSubscriptionSpecApis>[]>;
            /**
             ...
             */
            applications?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.ManagedSubscriptionSpecApplications>[]>;
            /**
             ...
             */
            managedApplications?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.ManagedSubscriptionSpecManagedApplications>[]>;
        ...
        interface ManagedSubscriptionSpecApiSelector {
             ...
             * matchExpressions is a list of label selector requirements. The requirements are ANDed.
             */
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.ManagedSubscriptionSpecApiSelectorMatchExpressions>[]>;
            /**
             * matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
             * map is equivalent to an element of matchExpressions, whose key field is "key", the
             * operator is "In", and the values array contains only "value". The requirements are ANDed.
        ...
        interface ManagedSubscriptionSpecApiSelectorPatch {
             ...
             * matchExpressions is a list of label selector requirements. The requirements are ANDed.
             */
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.ManagedSubscriptionSpecApiSelectorMatchExpressionsPatch>[]>;
            /**
             * matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
             * map is equivalent to an element of matchExpressions, whose key field is "key", the
             * operator is "In", and the values array contains only "value". The requirements are ANDed.
        ...
        interface ManagedSubscriptionSpecPatch {
             ...
             * Multiple ManagedSubscriptions can select the same APIBundles.
             */
            apiBundles?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.ManagedSubscriptionSpecApiBundlesPatch>[]>;
             ...
             * When combined with APISelector, this set of APIs is appended to the matching APIs.
             */
            apis?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.ManagedSubscriptionSpecApisPatch>[]>;
            /**
             * Applications references the Applications that will gain access to the specified APIs.
             * Multiple ManagedSubscriptions can select the same AppID.
             * Deprecated: Use ManagedApplications instead.
             */
            applications?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.ManagedSubscriptionSpecApplicationsPatch>[]>;
            /**
             * Claims specifies an expression that validate claims in order to authorize the request.
             */
            claims?: pulumi.Input<string>;
             ...
             * Multiple ManagedSubscriptions can select the same ManagedApplication.
             */
            managedApplications?: pulumi.Input<pulumi.Input<inputs.hub.v1alpha1.ManagedSubscriptionSpecManagedApplicationsPatch>[]>;
...
export declare namespace traefik {
    namespace v1alpha1 {
        ...
        interface IngressRouteSpec {
             ...
             */
            routes?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.IngressRouteSpecRoutes>[]>;
        ...
        interface IngressRouteSpecPatch {
             ...
             * Routes defines the list of routes.
             */
            routes?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.IngressRouteSpecRoutesPatch>[]>;
        ...
        interface IngressRouteSpecRoutes {
             ...
             */
            middlewares?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.IngressRouteSpecRoutesMiddlewares>[]>;
             ...
             */
            services?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.IngressRouteSpecRoutesServices>[]>;
            /**
        ...
        interface IngressRouteSpecRoutesPatch {
             ...
             * More info: https://doc.traefik.io/traefik/v3.5/routing/providers/kubernetes-crd/#kind-middleware
             */
            middlewares?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.IngressRouteSpecRoutesMiddlewaresPatch>[]>;
             ...
             * It can contain any combination of TraefikService and/or reference to a Kubernetes Service.
             */
            services?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.IngressRouteSpecRoutesServicesPatch>[]>;
            /**
             * Syntax defines the router's rule syntax.
             * More info: https://doc.traefik.io/traefik/v3.5/routing/routers/#rulesyntax
             * Deprecated: Please do not use this field and rewrite the router rules to use the v3 syntax.
        ...
        interface IngressRouteSpecTls {
             ...
             */
            domains?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.IngressRouteSpecTlsDomains>[]>;
        ...
        interface IngressRouteSpecTlsPatch {
             ...
             * More info: https://doc.traefik.io/traefik/v3.5/routing/routers/#domains
             */
            domains?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.IngressRouteSpecTlsDomainsPatch>[]>;
        ...
        interface IngressRouteTCPSpec {
             ...
             * Routes defines the list of routes.
             */
            routes?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.IngressRouteTCPSpecRoutes>[]>;
        ...
        interface IngressRouteTCPSpecPatch {
             ...
             * Routes defines the list of routes.
             */
            routes?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.IngressRouteTCPSpecRoutesPatch>[]>;
        ...
        interface IngressRouteTCPSpecRoutes {
             ...
             */
            middlewares?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.IngressRouteTCPSpecRoutesMiddlewares>[]>;
            /**
             * Priority defines the router's priority.
             ...
             */
            services?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.IngressRouteTCPSpecRoutesServices>[]>;
            /**
             * Syntax defines the router's rule syntax.
        ...
        interface IngressRouteTCPSpecRoutesPatch {
             ...
             * Middlewares defines the list of references to MiddlewareTCP resources.
             */
            middlewares?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.IngressRouteTCPSpecRoutesMiddlewaresPatch>[]>;
            /**
             * Priority defines the router's priority.
             * More info: https://doc.traefik.io/traefik/v3.5/routing/routers/#priority_1
             */
             ...
             * Services defines the list of TCP services.
             */
            services?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.IngressRouteTCPSpecRoutesServicesPatch>[]>;
            /**
             * Syntax defines the router's rule syntax.
             * More info: https://doc.traefik.io/traefik/v3.5/routing/routers/#rulesyntax_1
             * Deprecated: Please do not use this field and rewrite the router rules to use the v3 syntax.
        ...
        interface IngressRouteTCPSpecTls {
             ...
             * More info: https://doc.traefik.io/traefik/v3.5/routing/routers/#domains
             */
            domains?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.IngressRouteTCPSpecTlsDomains>[]>;
        ...
        interface IngressRouteTCPSpecTlsPatch {
             ...
             * More info: https://doc.traefik.io/traefik/v3.5/routing/routers/#domains
             */
            domains?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.IngressRouteTCPSpecTlsDomainsPatch>[]>;
        ...
        interface IngressRouteUDPSpec {
             ...
             * Routes defines the list of routes.
             */
            routes?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.IngressRouteUDPSpecRoutes>[]>;
        }
        /**
         * IngressRouteUDPSpec defines the desired state of a IngressRouteUDP.
         */
        interface IngressRouteUDPSpecPatch {
             ...
             * Routes defines the list of routes.
             */
            routes?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.IngressRouteUDPSpecRoutesPatch>[]>;
        }
        /**
        ...
        interface IngressRouteUDPSpecRoutes {
             ...
             */
            services?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.IngressRouteUDPSpecRoutesServices>[]>;
        }
        /**
         * RouteUDP holds the UDP route configuration.
         */
        interface IngressRouteUDPSpecRoutesPatch {
             ...
             * Services defines the list of UDP services.
             */
            services?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.IngressRouteUDPSpecRoutesServicesPatch>[]>;
        }
        /**
        ...
        interface MiddlewareSpecChain {
             ...
             */
            middlewares?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.MiddlewareSpecChainMiddlewares>[]>;
        }
        /**
         * MiddlewareRef is a reference to a Middleware resource.
         */
        ...
        interface MiddlewareSpecChainPatch {
             ...
             * Middlewares is the list of MiddlewareRef which composes the chain.
             */
            middlewares?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.MiddlewareSpecChainMiddlewaresPatch>[]>;
        }
        /**
        ...
        interface ServersTransportSpec {
             ...
             */
            rootCAs?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.ServersTransportSpecRootCAs>[]>;
            /**
        ...
        interface ServersTransportSpecPatch {
             ...
             * RootCAs defines a list of CA certificate Secrets or ConfigMaps used to validate server certificates.
             */
            rootCAs?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.ServersTransportSpecRootCAsPatch>[]>;
            /**
             * RootCAsSecrets defines a list of CA secret used to validate self-signed certificate.
             * Deprecated: RootCAsSecrets is deprecated, please use the RootCAs option instead.
             */
        ...
        interface ServersTransportTCPSpecTls {
             ...
             * RootCAs defines a list of CA certificate Secrets or ConfigMaps used to validate server certificates.
             */
            rootCAs?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.ServersTransportTCPSpecTlsRootCAs>[]>;
            /**
             * RootCAsSecrets defines a list of CA secret used to validate self-signed certificate.
             * Deprecated: RootCAsSecrets is deprecated, please use the RootCAs option instead.
             */
        ...
        interface ServersTransportTCPSpecTlsPatch {
             ...
             * RootCAs defines a list of CA certificate Secrets or ConfigMaps used to validate server certificates.
             */
            rootCAs?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.ServersTransportTCPSpecTlsRootCAsPatch>[]>;
            /**
             * RootCAsSecrets defines a list of CA secret used to validate self-signed certificate.
             * Deprecated: RootCAsSecrets is deprecated, please use the RootCAs option instead.
             */
        ...
        interface TLSStoreSpec {
             ...
             */
            certificates?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.TLSStoreSpecCertificates>[]>;
        ...
        interface TLSStoreSpecPatch {
             ...
             * Certificates is a list of secret names, each secret holding a key/certificate pair to add to the store.
             */
            certificates?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.TLSStoreSpecCertificatesPatch>[]>;
        ...
        interface TraefikServiceSpecMirroring {
             ...
             */
            mirrors?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.TraefikServiceSpecMirroringMirrors>[]>;
            /**
             * Name defines the name of the referenced Kubernetes Service or TraefikService.
             * The differentiation between the two is specified in the Kind field.
             */
        ...
        interface TraefikServiceSpecMirroringPatch {
             ...
             * Mirrors defines the list of mirrors where Traefik will duplicate the traffic.
             */
            mirrors?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.TraefikServiceSpecMirroringMirrorsPatch>[]>;
            /**
             * Name defines the name of the referenced Kubernetes Service or TraefikService.
             * The differentiation between the two is specified in the Kind field.
             */
        ...
        interface TraefikServiceSpecWeighted {
             ...
             */
            services?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.TraefikServiceSpecWeightedServices>[]>;
        ...
        interface TraefikServiceSpecWeightedPatch {
             ...
             * Services defines the list of Kubernetes Service and/or TraefikService to load-balance, with weight.
             */
            services?: pulumi.Input<pulumi.Input<inputs.traefik.v1alpha1.TraefikServiceSpecWeightedServicesPatch>[]>;
