 ...
 */
export declare class IngressRoute extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IngressRoute;
    /**
     * Returns true if the given object is an instance of IngressRoute.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is IngressRoute;
    /**
    ...
    readonly spec: pulumi.Output<outputs.traefik.v1alpha1.IngressRouteSpec>;
    /**
