 ...
 */
export declare class TLSOption extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TLSOption;
    /**
     * Returns true if the given object is an instance of TLSOption.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TLSOption;
    /**
    ...
    readonly spec: pulumi.Output<outputs.traefik.v1alpha1.TLSOptionSpec>;
    /**
