 ...
 */
export declare class TLSStore extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TLSStore;
    /**
     * Returns true if the given object is an instance of TLSStore.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TLSStore;
    /**
    ...
    readonly spec: pulumi.Output<outputs.traefik.v1alpha1.TLSStoreSpec>;
    /**
