...
exports.IngressRouteTCP = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../../utilities");
/**
 * IngressRouteTCP is the CRD implementation of a Traefik TCP Router.
 */
class IngressRouteTCP extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        return new IngressRouteTCP(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.IngressRouteTCP = IngressRouteTCP;
/** @internal */
IngressRouteTCP.__pulumiType = 'kubernetes:traefik.io/v1alpha1:IngressRouteTCP';
//# sourceMappingURL=ingressRouteTCP.js.map