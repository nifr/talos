 ...
 */
export declare class TraefikService extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TraefikService;
    /**
     * Returns true if the given object is an instance of TraefikService.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TraefikService;
    /**
    ...
    readonly spec: pulumi.Output<outputs.traefik.v1alpha1.TraefikServiceSpec>;
    /**
