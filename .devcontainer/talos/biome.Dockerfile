...
ARG biome_architecture="${TARGETARCH}"
ARG biome_architecture="${biome_architecture/amd64/x64}"
## example url: https://github.com/biomejs/biome/releases/download/%40biomejs%2Fbiome%402.2.4/biome-linux-arm64-musl
## example url: 'https://github.com/biomejs/biome/releases/download/%40biomejs%2Fbiome%402.2.4/biome-linux-arm64-musl'
ARG biome_download_url="https://github.com/biomejs/biome/releases/download/%40biomejs%2Fbiome%40${biome_version}/biome-linux-${biome_architecture}-musl"
